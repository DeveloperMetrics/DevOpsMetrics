...
namespace DevOpsMetrics.Web.Services
{
    public class ServiceApiClient
    {
        ...
        //public async Task<List<AzureDevOpsBuild>> GetAzureDevOpsDeployments(bool getSampleData, string patToken, string organization, string project, string branch, string buildId)
        //{
        ...
        //    else
        //    {
        //        string url = $"/api/DeploymentFrequency/GetAzureDevOpsDeployments?getSampleData={getSampleData}&patToken={patToken}&organization={organization}&project={project}&AzureDevOpsbranch={branch}&buildId={buildId}";
        ...
        //public async Task<List<GitHubActionsRun>> GetGitHubDeployments(bool getSampleData, string owner, string repo, string branch, string workflowId)
        //{
        //    if (getSampleData == true)
        //    {
        ...
        //    else
        //    {
        //        string url = $"/api/DeploymentFrequency/GetGitHubDeployments?getSampleData={getSampleData}&owner={owner}&repo={repo}&GHbranch={branch}&workflowId={workflowId}";
