...
namespace DevOpsMetrics.Core.DataAccess.TableStorage
{
    public interface IAzureTableStorageDA
    {
        ...
        Task<bool> UpdateAzureDevOpsSettingInStorage(string patToken, TableStorageConfiguration tableStorageConfig, string settingsTable, string organization, string project, string repository, string branch, string buildName, string buildId, string resourceGroupName, int itemOrder);
        ...
        Task<bool> LogAzureDevOpsProcessorRunInStorage(TableStorageConfiguration tableStorageConfig, ProjectLog log);
        Task<bool> LogGitHubProcessorRunInStorage(TableStorageConfiguration tableStorageConfig, ProjectLog log);
    }
}